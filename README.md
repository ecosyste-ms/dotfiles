# [Ecosyste.ms: Dotfiles](https://dotfiles.ecosyste.ms)
...
Documentation for the REST API is available here: [https://dotfiles.ecosyste.ms/docs](https://dotfiles.ecosyste.ms/docs)
...
Please do! The source code is hosted at [GitHub](https://github.com/ecosyste-ms/dotfiles). If you want something, [open an issue](https://github.com/ecosyste-ms/dotfiles/issues/new) or a pull request.

If you need want to contribute but don't know where to start, take a look at the issues tagged as ["Help Wanted"](https://github.com/ecosyste-ms/dotfiles/issues?q=is%3Aopen+is%3Aissue+label%3A%22help+wanted%22).
...
We support and encourage security research on Ecosyste.ms under the terms of our [vulnerability disclosure policy](https://github.com/ecosyste-ms/dotfiles/security/policy).
